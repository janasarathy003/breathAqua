    ...
    <div class="card">
      <div class="card-body">
        <div class="table-scrollable"  >
          ...
          <table cellspacing="10"  cellpadding="10" class="table table-sm table-bordered table-striped text-center">
            <thead>
              <tr>
                ...
                <th class='{sorter: false}'>Delete  <br><input type="checkbox" class="  " id="select_col_4"/>   </th>
              </tr>
              <tr>
              </tr>
            </thead>
