...
<div class="page-header">
    <h4 class="page-title">Deposite Management</h4>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><?= Html::a('Deposite Management', ['index'], ['class' => '' ]) ?></li>
            ...
            <div class="card-body">              
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <div>
                            <?php 
                                $inAr = array('yes'=>'Yes','wayOff'=>'Wayoff');
                            ?>
                            <?= $form->field($model, 'isDeposite')->dropDownList($inAr, ['class'=>'form-control input-sm']) ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div>
                            <?php 
                                $inAr = array('no'=>'No','yes'=>'Yes');
                            ?>
                            <?= $form->field($model, 'isReturn')->dropDownList($inAr, ['class'=>'form-control input-sm']) ?>
                        </div>
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <div>
                            <?= $form->field($model, 'noOfCanDeposite')->textInput(['maxlength' => true,'class'=>'form-control input-sm','placeholder'=>true]) ?>
                        </div>
                    </div>  
                    <div class="col-md-4">
                        <div>
                            <?= $form->field($model, 'depositeAmount')->textInput(['maxlength' => true,'class'=>'form-control input-sm','placeholder'=>true]) ?>
                        </div>
                    </div>           
                    <div class=" col-md-4">
                        <div>
