...
<!-- <div class="leftmenu-management-form"> -->
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><?= Html::a('Menu Management', ['index'], ['class' => '' ]) ?></li>
			   ...
			   <?php $form = ActiveForm::begin(); ?>
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="  col-md-3">
                            <div>
                                <?= $form->field($model, 'menuFor')->dropDownList([ 'admin' => 'Admin'], ['class'=>'form-control']) ?>
                            </div>
                        </div>
                        <div class="  col-md-3">
                            <div>
                                <?= $form->field($model, 'menuTpe')->dropDownList([ 'menu' => 'Menu', 'group' => 'Group', 'submenu' => 'Submenu', ], ['prompt' => 'select','class'=>'form-control']) ?>
                            </div>
                        </div>
                        <div class="  col-md-3">
                            <div>
                        ...
                        <div class="  col-md-3">
                            <div>
                                <?= $form->field($model, 'userUrl')->textInput(['maxlength' => true,'class'=>'form-control','placeholder'=>true]) ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="  col-md-4" id="groupDiv">
                            <div>
                                <?php 
                                  $groups = LeftmenuManagement::find()->where(['activeStatus'=>'A'])->andWhere(['menuTpe'=>'group'])->asArray()->all();
                                  $groupsAr = ArrayHelper::map($groups,'groupId','Name');
                                  ?>
                                <?= $form->field($model, 'groupId')->dropDownList($groupsAr,['prompt'=>'Select..','class'=>'form-control','value'=>$model->groupId]);?>
                        ...
                        <div class="col-sm-4">
						 <label class="control-label">Icon</label>
                           <div class="input-group mb-4">
                                ...
                                <input type="text" id="leftmenumanagement-faicon" name="LeftmenuManagement[faIcon]" class="form-control icon-class-input form-control" value="<?php echo $model->faIcon; ?>">
                                <button class="btn btn-outline-primary picker-button" type="button">Pick an Icon</button>
                                <button type="button" class="demo-icon btn btn-sm btn-outline-default"></button>
                           </div> 
                        </div> 
                        <?php /*
                        <div class="  col-md-4">
                            <div>
                                <?= $form->field($model, 'faIcon')->textInput(['maxlength' => true,'class'=>'form-control ','placeholder'=>true]) ?>
                            </div>
                        </div> */ ?>
                        <div class=" col-md-4">
                            <div>
                                <?php
                                    $acSt = 'A';
                                    if($model->activeStatus!=""&&$model->activeStatus!=NULL){
                                        $acSt = $model->activeStatus;
                                    }
                                    ?>
                                <?= $form->field($model, 'activeStatus')->dropDownList([ 'A' => 'Active', 'I' => 'InActive', ], ['value'=>$acSt]) ?>
                            </div>
                        </div>
...
<!-- MODAL -->
<div id="iconPicker" class="modal fade" data-keyboard="false" data-backdrop="static">
