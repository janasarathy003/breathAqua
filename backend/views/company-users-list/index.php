...
$this->title = 'Company Users Lists';
   ...
   <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header" >
                <h3 class="card-title">Company Users Lists</h3>
                            ...
                            [
                                ...
                                'buttons'=>[
                                    ...
                                    'delete' => function ($url, $model, $key) { 
                                        ...
                                        $url=Url::base().'/company-user-d/'.$model->autoId;
                                    ...
                                    'update' => function ($url, $model, $key) {
                                        $url=Url::base()."/company-user-u/".$model->autoId;
                                          $options = array_merge([
