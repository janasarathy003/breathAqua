            ...
            <div class="card-body">              
                <div class="form-row">
                    <div class="col-md-3">
                        <div>
                            <?php 
                                $inAr = ArrayHelper::map(UserManagement::find()->where(['status'=>'A'])->andWhere(['userType'=>'company'])->asArray()->all(),'userId','name');
                            ?>
                            <?= $form->field($model, 'userId')->dropDownList($inAr, ['class'=>'form-control input-sm','prompt'=>'Select Company..']) ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        <div>
                            <?= $form->field($model, 'departmentName')->textInput(['maxlength' => true,'class'=>'form-control input-sm','placeholder'=>true]) ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div>
                            <?= $form->field($model, 'designationName')->textInput(['maxlength' => true,'class'=>'form-control input-sm','placeholder'=>true]) ?>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div>
