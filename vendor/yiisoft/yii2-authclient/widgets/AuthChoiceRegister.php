 ...
 * @since 2.0
 */
class AuthChoiceRegister extends Widget
{
    /**
    ...
    public function clientLink($client, $text = null, array $htmlOptions = [])
    {
        ...
        if (empty($viewOptions['widget'])) {
            if ($text === null) {
				  ...
				  $text= Html::tag('span ', 'Log / Register with Facebook', ['class' => '' . $client->getName()]);
            ...
            Html::addCssClass($htmlOptions, ['widget' => 'btn btn-primary highlight-button'],['style' => 'margin-top:20px']);
    ...
    protected function renderMainContent()
    {
        ...
        foreach ($this->getClients() as $externalService) {
            $items[] = Html::tag('a', $this->clientLink($externalService));
        }
        return Html::tag('center', implode('', $items));
    }
