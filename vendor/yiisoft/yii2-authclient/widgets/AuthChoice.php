      ...
      //  echo "<pre>"; print_r($client); die;
        if (empty($viewOptions['widget'])) {
            if ($text === null) {
				  ...
				  $text= Html::tag('span ', 'Login / Register using Google Account', ['class' => '' . $client->getName()]);
            ...
            Html::addCssClass($htmlOptions, ['widget' => 'btn btn-info highlight-button'],['style' => 'margin-top:20px']);
