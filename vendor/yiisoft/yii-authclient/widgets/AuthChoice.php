    ...
    public function clientLink($client, $text = null, array $htmlOptions = [])
    {
        ...
        if (empty($viewOptions['widget'])) {
            if ($text === null) {
				  ...
				  $text= Html::tag('span ', 'Log in with Google', ['class' => 'btn btn-google btn-block' . $client->getName()]);
            ...
            Html::addCssClass($htmlOptions, ['widget' => 'btn btn-secondary highlight-button'],['style' => 'margin-top:20px']);
